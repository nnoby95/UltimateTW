...
function openVillageListPopup() {
    ...
    var options = [
        { value: "16606", text: "Complete offensive" },
        { value: "16607", text: "Attack arriving" },
        { value: "16608", text: "Contains noble" },
    ...
    // Create village rows dynamically
    Object.keys(villagesInfo).forEach(index => {
        ...
        villageTd2.textContent = village.coords ? village.coords : "N/A"; // Here can be adjusted to display coordinates if available
...
function injectNavigationBar() {
    if (settings_cookies.general['show__navigation_bar']) {
        ...
        // Select the element with class 'maincell'
        ...
        // Create edit icon on the right side
        const editIcon = document.createElement('img');
        editIcon.src = "https://dspt.innogamescdn.com/asset/243a567d/graphic/plus.png";
        editIcon.alt = "Edit";
        ...
        editIcon.style.float = "right"; // Keeps the icon as far right as possible
        editIcon.title = "Edit Navigation Bar";
        editIcon.addEventListener("click", function () {
            alert("Edit navigation (future action)"); // Here you can replace with the real editing code
        });

        // Add the icon to the right cell
