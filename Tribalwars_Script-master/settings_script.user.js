...
function saveScriptSettings() {
    ...
    for (var i = 0; i < allSettings.length; i++) {
        ...
        // Checks if the setting has extraSettings
        ...
        if (parts.length === 3) {
            ...
            // If it has extraSettings, saves as "enabled"
            ...
            // Simple settings (example: "show__overview_premmium_info")
            settings_cookies.general[settingName] = settingValue;
        }
    }

    // Remove empty keys (in case something was created incorrectly)
    ...
    // Saves to localStorage maintaining the entire original structure
